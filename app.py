...
API_KEY = "AIdaSyCy-deh-OU6ELDhTpT4rxqRMaNmQCKhrFs"
    ...
    if request.method == 'POST':
        ...
        if "message" in update and "text" in update["message"]:
            ...
            payload = {
                ...
                "systemInstruction": {"parts": [{"text": "You are ANKIT AI, a sharp, smart, and helpful assistant."}]}
            }
            ...
            try:
                ...
                bot_reply = "Sorry bhai, thoda network issue chal raha hai."
